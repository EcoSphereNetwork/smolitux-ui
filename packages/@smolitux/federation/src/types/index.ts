...
// Step 2: Update the main index.ts file to avoid duplicate exports
// src/index.ts
...
// Step 3: Update the component files to use the shared types
// For example, update the FederatedSearch.tsx file:

// src/components/FederatedSearch/FederatedSearch.tsx
...
// Similarly update the other component files
