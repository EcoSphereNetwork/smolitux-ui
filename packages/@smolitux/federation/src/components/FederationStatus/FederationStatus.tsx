        ...
        <div className="p-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-3 bg-white dark:bg-gray-700 rounded-md shadow-sm">
              <div className="flex items-center">
                <div className={`w-3 h-3 rounded-full mr-2 ${federationStatus.isActive ? 'bg-green-500' : 'bg-red-500'}`} />
            ...
            <div key={platform.id} className="divide-y divide-gray-200 dark:divide-gray-700">
              ...
              >
                <div className="flex items-center">
                  ...
                  {/* Status */}
                  <div className="ml-4">
                    {getConnectionStatusBadge(platform.connectionStatus)}
                  </div>
                </div>
              </div>
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                          ...
                          {platform.syncStatus.syncedItems !== undefined && platform.syncStatus.totalItems !== undefined && (
                            <span className="ml-2">
                              ({platform.syncStatus.syncedItems} / {platform.syncStatus.totalItems})
                            </span>
                          )}
                        </p>
                      </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {platform.connectionStatus === 'connected' ? (
                      ...
                      <Button
                        ...
                        disabled={actionInProgress === platform.id || platform.connectionStatus === 'error'}
                      >
                      ...
                      <>
                        {platform.syncStatus?.isActive ? (
                          <Button
                            ...
                            disabled={actionInProgress === platform.id}
                          >
                            {actionInProgress === platform.id ? 'Wird gestoppt...' : 'Synchronisierung stoppen'}
                          </Button>
                        ) : (
                          <Button
                            variant="outline"
                            ...
                            disabled={actionInProgress === platform.id}
                          >
                            {actionInProgress === platform.id ? 'Wird gestartet...' : 'Synchronisierung starten'}
                          </Button>
                        )}
                      </>
                    )}
