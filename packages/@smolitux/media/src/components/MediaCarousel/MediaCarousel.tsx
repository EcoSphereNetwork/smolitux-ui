...
export const MediaCarousel: React.FC<MediaCarouselProps> = ({
  ...
  const renderPlaceholders = () => {
    return Array.from({ length: visibleItems }).map((_, index) => (
      ...
      >
        <div className={`${variant === 'featured' && index === 0 ? 'aspect-[16/9]' : 'aspect-video'} bg-gray-200 dark:bg-gray-700 rounded-lg`} />
            ...
            {loading ? (
              ...
              items.map((item, index) => (
                ...
                >
                  ...
                  >
                    {/* Thumbnail */}
                    <div className={`relative ${index === 0 ? 'aspect-[16/9]' : 'aspect-video'} bg-gray-200 dark:bg-gray-700 overflow-hidden`}>
                      <img
                    ...
                    {/* Inhalt */}
                    <div className="p-3">
                      <h3 className={`${index === 0 ? 'text-lg' : 'text-sm'} font-semibold text-gray-900 dark:text-white line-clamp-2`}>
                        {item.title}
                      </h3>
