...
describe('MediaCarousel Accessibility', () => {
  ...
  test('should not have accessibility violations', async () => {
    const { container } = render(
      <MediaCarousel items={mockItems} aria-label="Media carousel with images and videos" />
    );
  ...
  test('should have accessible indicators', () => {
    const { container } = render(<MediaCarousel items={mockItems} showIndicators={true} />);
  ...
  test('should have accessible video elements', () => {
    const { container } = render(<MediaCarousel items={mockItems} initialIndex={2} />);
  ...
  test('should have accessible captions when shown', () => {
    const { container } = render(<MediaCarousel items={mockItems} showCaptions={true} />);
