...
describe('MediaCarousel', () => {
  ...
  test('renders with custom navigation buttons', () => {
    render(<MediaCarousel items={mockItems} prevButtonText="Back" nextButtonText="Forward" />);
  ...
  test('renders with custom indicator component', () => {
    ...
    render(
      <MediaCarousel items={mockItems} showIndicators={true} indicatorComponent={CustomIndicator} />
    );
