...
describe('Responsive Utilities', () => {
  ...
  describe('getMediaQuery', () => {
    ...
    it('returns between media query when specified', () => {
      expect(getMediaQuery(theme, 'md', 'between', 'lg')).toBe('@media (min-width: 768px) and (max-width: 991.98px)');
    });
    
    it('returns only media query when specified', () => {
      expect(getMediaQuery(theme, 'md', 'only')).toBe('@media (min-width: 768px) and (max-width: 991.98px)');
    });
