...
export type TranslationResources = Record<Locale, Record<TranslationNamespace, Record<TranslationKey, string>>>;
...
export type I18nContextValue = {
   ...
   */
  addResources: (locale: Locale, namespace: TranslationNamespace, resources: Record<TranslationKey, string>) => void;
  
  /**
   * Fügt eine Übersetzung hinzu
   */
  addTranslation: (locale: Locale, namespace: TranslationNamespace, key: TranslationKey, value: string) => void;
