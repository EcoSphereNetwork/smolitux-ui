...
describe('TokenDistributionChart', () => {
  ...
  it('calls onExport when export button is clicked', () => {
    render(
      <TokenDistributionChart distributionData={mockDistributionData} onExport={mockOnExport} />
    );
  ...
  it('displays chart title when provided', () => {
    ...
    render(<TokenDistributionChart distributionData={mockDistributionData} title={title} />);
  ...
  it('displays detailed information when a segment is selected', () => {
    render(
      <TokenDistributionChart distributionData={mockDistributionData} showDetailedView={true} />
    );
