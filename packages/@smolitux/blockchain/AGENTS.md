# Smolitux UI - blockchain Package

This document provides package-specific guidance for AI agents working with the `@smolitux/blockchain` package in the Smolitux UI component library.

## 📋 Package Overview

The `@smolitux/blockchain` package provides blockchain components for the Smolitux UI component library. These components are used to structure and organize the UI.

## 🧩 Component Categories

The blockchain package includes the following component categories:
...
For each component in the blockchain package, follow this workflow:
...
bash scripts/workflows/analyze-repo.sh --package blockchain --component $COMPONENT
```

### 2. Completion Phase
```bash
# Complete component
bash scripts/workflows/complete-components.sh --package blockchain --component $COMPONENT
```

### 3. Validation Phase
```bash
# Validate component
bash scripts/workflows/validate-quality.sh --package blockchain --component $COMPONENT
```
...
All blockchain components must meet the following requirements:
...
- [blockchain Package Guidelines](../../docs/wiki/codex/package-specific/blockchain.md)
