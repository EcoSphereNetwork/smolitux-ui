...
export const WithMultipleSources: Story = {
  render: () => (
    ...
    >
      ...
      <p>Ihr Browser unterstützt kein HTML5-Video. Hier ist ein <a href="https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4">Link zum Video</a>.</p>
    </MediaPlayer>
  ),
};
    ...
    return (
      <div className="w-[400px] bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
        <div className="mb-4">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">{playlist[currentTrack].artist}</p>
        </div>
