...
export const MediaPlayerA11y = forwardRef<MediaPlayerRef, MediaPlayerProps>(({
  ...
  }, [isPlaying, captionsOn, keyboardShortcuts, screenReaderAnnouncements, showKeyboardHelp, type]);
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            {volumeIndicator && (
              <div className="mr-4 flex items-center">
                <label htmlFor="volume-slider" className="sr-only">Lautstärke</label>
                <input 
                  id="volume-slider"
                  ref={volumeSliderRef}
                  type="range" 
          ...
          <div className="flex items-center">
            {speedIndicator && (
              <div className="mr-2">
                <label htmlFor="speed-selector" className="sr-only">Geschwindigkeit</label>
                <select 
                  id="speed-selector"
                  ref={speedSliderRef}
                  value={playbackSpeed}
  ...
  const ariaAttributes = {
    ...
    'aria-busy': ariaBusy,
    'aria-roledescription': ariaRoledescription || `${type === 'audio' ? 'Audio' : 'Video'} Player`,
  };
