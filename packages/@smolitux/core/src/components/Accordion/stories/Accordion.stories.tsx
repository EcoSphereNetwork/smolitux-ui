    ...
    children: [
      <AccordionItem key="1" title="Was ist Smolitux UI?">
        <p>
          ...
          wiederverwendbaren UI-Komponenten für moderne Webanwendungen bietet. Die Bibliothek
          ist mit TypeScript entwickelt und bietet eine umfassende Dokumentation.
        </p>
      </AccordionItem>,
      <AccordionItem key="2" title="Wie installiere ich Smolitux UI?">
        <p>
          Sie können Smolitux UI mit npm oder yarn installieren:
        </p>
      ...
      <AccordionItem key="3" title="Welche Komponenten sind verfügbar?">
        <p>
          Smolitux UI bietet eine Vielzahl von Komponenten, darunter:
        </p>
  ...
  args: {
    ...
    children: [
      <AccordionItem key="1" title="Abschnitt 1">
        ...
        <p className="mt-2">
          Dieser Abschnitt enthält mehrere Absätze, um zu demonstrieren, wie der Inhalt
          in einem Accordion-Panel dargestellt wird.
        </p>
      </AccordionItem>,
      <AccordionItem key="2" title="Abschnitt 2">
        <p>Inhalt für Abschnitt 2</p>
        <p className="mt-2">
          Mit der Option <code>allowMultiple</code> können mehrere Panels gleichzeitig
          geöffnet sein.
        </p>
      </AccordionItem>,
  ...
  args: {
    ...
    children: [
      ...
      <AccordionItem key="2" title="Abschnitt 2">
        <p>Inhalt für Abschnitt 2</p>
        <p className="mt-2">
          Mit der Option <code>allowToggle</code> können alle Panels geschlossen werden.
          Klicken Sie auf ein geöffnetes Panel, um es zu schließen.
        </p>
      </AccordionItem>,
      <AccordionItem key="3" title="Abschnitt 3">
        <p>Inhalt für Abschnitt 3</p>
