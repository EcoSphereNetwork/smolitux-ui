  ...
  (
    ...
    const justifyItemsClasses = justifyItems
      ? typeof justifyItems === 'object'
        ? Object.entries(justifyItems)
            .map(([breakpoint, value]) => justifyItemsMap[breakpoint][value])
            .join(' ')
    ...
    const alignItemsClasses = alignItems
      ? typeof alignItems === 'object'
        ? Object.entries(alignItems)
            .map(([breakpoint, value]) => alignItemsMap[breakpoint][value])
            .join(' ')
    ...
    const justifyContentClasses = justifyContent
      ? typeof justifyContent === 'object'
        ? Object.entries(justifyContent)
            .map(([breakpoint, value]) => justifyContentMap[breakpoint][value])
            .join(' ')
    ...
    const alignContentClasses = alignContent
      ? typeof alignContent === 'object'
        ? Object.entries(alignContent)
            .map(([breakpoint, value]) => alignContentMap[breakpoint][value])
            .join(' ')
    ...
    const flowClasses = flow
      ? typeof flow === 'object'
        ? Object.entries(flow)
            .map(([breakpoint, value]) => flowMap[breakpoint][value])
            .join(' ')
        : flowMap['base'][flow]
      : '';
    ...
    const autoColumnsClasses = autoColumns
      ? typeof autoColumns === 'object'
        ? Object.entries(autoColumns)
            .map(([breakpoint, value]) => autoColumnsMap[breakpoint][value])
            .join(' ')
    ...
    const autoRowsClasses = autoRows
      ? typeof autoRows === 'object'
        ? Object.entries(autoRows)
            .map(([breakpoint, value]) => autoRowsMap[breakpoint][value])
            .join(' ')
