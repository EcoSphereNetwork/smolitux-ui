...
export const SelectA11y = forwardRef<HTMLSelectElement, SelectProps>(({
  ...
  const effectClasses = {
    ...
    focus: focusable && !_disabled ? 'focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-400 dark:focus:border-primary-400' : '',
  ...
  const handleFocus = (e: React.FocusEvent<HTMLSelectElement>) => {
    ...
    setAnnounceMessage('Dropdown geöffnet. Verwenden Sie die Pfeiltasten, um durch die Optionen zu navigieren.');
  };
