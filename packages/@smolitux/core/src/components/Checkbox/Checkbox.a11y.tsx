...
export const CheckboxA11y = forwardRef<HTMLInputElement, CheckboxProps>(
  (
    ...
    const colorSchemeClasses = {
      primary:
        'checked:bg-primary-500 checked:border-primary-500 dark:checked:bg-primary-400 dark:checked:border-primary-400',
      secondary:
        'checked:bg-secondary-500 checked:border-secondary-500 dark:checked:bg-secondary-400 dark:checked:border-secondary-400',
      success:
        'checked:bg-green-500 checked:border-green-500 dark:checked:bg-green-400 dark:checked:border-green-400',
      danger:
        'checked:bg-red-500 checked:border-red-500 dark:checked:bg-red-400 dark:checked:border-red-400',
      warning:
        'checked:bg-yellow-500 checked:border-yellow-500 dark:checked:bg-yellow-400 dark:checked:border-yellow-400',
      info: 'checked:bg-blue-500 checked:border-blue-500 dark:checked:bg-blue-400 dark:checked:border-blue-400',
      neutral:
        'checked:bg-gray-500 checked:border-gray-500 dark:checked:bg-gray-400 dark:checked:border-gray-400',
    };
    ...
    const effectClasses = {
      ...
      error: _isInvalid
        ...
        : '',
      success: _isSuccess
        ? 'border-green-500 dark:border-green-400 focus:ring-green-500 focus:border-green-500 dark:focus:ring-green-400 dark:focus:border-green-400'
        : '',
    ...
    return (
      ...
      >
        ...
        {label && (
          <label id={`${uniqueId}-label`} htmlFor={uniqueId} className={labelClasses}>
            {label}
            {_required && (
