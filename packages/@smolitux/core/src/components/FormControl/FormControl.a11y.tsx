...
export const FormControlA11y = forwardRef<HTMLDivElement, FormControlProps>(
  (
    ...
    const getLabelClasses = () => {
      ...
      switch (labelPosition) {
        ...
        case 'floating':
          return [
            ...baseClasses,
            'absolute left-2 top-0 px-1 bg-white dark:bg-gray-800 text-xs transform -translate-y-1/2 pointer-events-none transition-all duration-200',
          ].join(' ');
        default: // top
    ...
    const renderCounter = () => {
      ...
      const isOverLimit =
        counterMax !== undefined && counterValue !== undefined && counterValue > counterMax;
    ...
    return (
      <FormControlContext.Provider value={formControlContextValue}>
        <div ref={ref} className={containerClasses} {...rest} {...getAriaAttributes()}>
          {/* Label */}
          {label && (
            <label
              id={labelId}
