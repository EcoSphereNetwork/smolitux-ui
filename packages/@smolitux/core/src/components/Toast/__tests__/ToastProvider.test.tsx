...
const TestComponent = () => {
  ...
  return (
    <div>
      <button data-testid="show-info" onClick={() => toast.info('Info Toast')}>
        Show Info
      </button>
      <button data-testid="show-success" onClick={() => toast.success('Success Toast')}>
        Show Success
      </button>
      <button data-testid="show-warning" onClick={() => toast.warning('Warning Toast')}>
        Show Warning
      </button>
      <button data-testid="show-error" onClick={() => toast.error('Error Toast')}>
        Show Error
      </button>
      <button
        data-testid="show-custom"
        onClick={() => toast.show({ message: 'Custom Toast', title: 'Custom' })}
      >
        Show Custom
      </button>
      <button data-testid="close-all" onClick={() => toast.closeAll()}>
        Close All
      </button>
    </div>
  );
