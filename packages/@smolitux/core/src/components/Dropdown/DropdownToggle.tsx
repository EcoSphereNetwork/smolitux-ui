...
export const DropdownToggle = React.forwardRef<HTMLButtonElement, DropdownToggleProps>(({
  ...
  const variantClasses = {
    ...
    primary: 'bg-primary-600 text-white border border-primary-600 hover:bg-primary-700 dark:bg-primary-700 dark:border-primary-700 dark:hover:bg-primary-800',
    secondary: 'bg-secondary-600 text-white border border-secondary-600 hover:bg-secondary-700 dark:bg-secondary-700 dark:border-secondary-700 dark:hover:bg-secondary-800',
    outline: 'bg-transparent text-gray-800 border border-gray-300 hover:bg-gray-50 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-800',
    ghost: 'bg-transparent text-gray-800 border-none hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800'
  };
