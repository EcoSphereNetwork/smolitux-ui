...
const meta: Meta<typeof Dropdown> = {
  ...
  argTypes: {
    ...
    closeOnEsc: {
      control: 'boolean',
      description: 'Gibt an, ob das Dropdown geschlossen werden soll, wenn die Escape-Taste gedrückt wird',
    },
    closeOnSelect: {
      control: 'boolean',
      description: 'Gibt an, ob das Dropdown geschlossen werden soll, wenn ein Element ausgewählt wird',
    },
    autoSelect: {
      control: 'boolean',
    ...
    returnFocusOnClose: {
      control: 'boolean',
      description: 'Gibt an, ob der Fokus zurückgesetzt werden soll, wenn das Dropdown geschlossen wird',
    },
    matchWidth: {
      control: 'boolean',
      description: 'Gibt an, ob die Breite des Dropdowns an die Breite des Triggers angepasst werden soll',
    },
    gutter: {
      control: 'number',
    ...
    flip: {
      control: 'boolean',
      description: 'Gibt an, ob das Dropdown umgedreht werden soll, wenn nicht genügend Platz vorhanden ist',
    },
    preventOverflow: {
      control: 'boolean',
      description: 'Gibt an, ob das Dropdown so positioniert werden soll, dass es nicht über den Viewport hinausragt',
    },
    boundary: {
      control: 'text',
    ...
    finalFocusRef: {
      description: 'Ref zum Element, das den Fokus erhalten soll, wenn das Dropdown geschlossen wird',
    },
    children: {
