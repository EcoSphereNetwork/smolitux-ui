...
export const DropdownMenuA11y = React.forwardRef<HTMLDivElement, DropdownMenuA11yProps>(({
  ...
  const variantClasses = {
    ...
    primary: 'bg-primary-50 border border-primary-200 shadow-lg dark:bg-primary-900 dark:border-primary-800',
    secondary: 'bg-gray-50 border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700'
  };
