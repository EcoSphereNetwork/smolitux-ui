...
export const DropdownToggleA11y = React.forwardRef<HTMLButtonElement, DropdownToggleA11yProps>(
  (
    ...
    const variantClasses = {
      ...
      primary:
        'bg-primary-600 text-white border border-primary-600 hover:bg-primary-700 focus:ring-primary-500 dark:bg-primary-700 dark:hover:bg-primary-800',
      secondary:
        'bg-gray-200 text-gray-700 border border-gray-200 hover:bg-gray-300 focus:ring-gray-500 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-600',
      outline:
        'bg-transparent text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-gray-500 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-700',
      ghost:
        'bg-transparent text-gray-700 border-0 hover:bg-gray-100 focus:ring-gray-500 dark:text-gray-200 dark:hover:bg-gray-700',
    };
