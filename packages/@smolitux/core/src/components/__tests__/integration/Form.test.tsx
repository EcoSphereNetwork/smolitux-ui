    ...
    const TestForm = () => {
      ...
      return (
        <form data-testid="test-form" onSubmit={validateForm}>
          <Input label="Name" name="name" placeholder="Enter your name" error={errors.name} />
          <Input
            label="Email"
            name="email"
            type="email"
          ...
          <Checkbox name="terms" label="I agree to the terms and conditions" error={errors.terms} />
          <Button type="submit">Submit</Button>
        </form>
      );
    };
