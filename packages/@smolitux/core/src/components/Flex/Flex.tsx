...
export const Flex = forwardRef<HTMLDivElement, FlexProps>(({
  ...
  const directionClasses = typeof direction === 'object'
  ...
  const wrapClasses = typeof wrap === 'object'
    ? Object.entries(wrap).map(([breakpoint, value]) => {
        const prefix = breakpoint === 'sm' ? 'sm:' :
                      breakpoint === 'md' ? 'md:' :
                      breakpoint === 'lg' ? 'lg:' :
                      breakpoint === 'xl' ? 'xl:' :
  ...
  const justifyClasses = typeof justify === 'object'
    ? Object.entries(justify).map(([breakpoint, value]) => {
        const prefix = breakpoint === 'sm' ? 'sm:' :
                      breakpoint === 'md' ? 'md:' :
                      breakpoint === 'lg' ? 'lg:' :
                      breakpoint === 'xl' ? 'xl:' :
  ...
  const alignClasses = typeof align === 'object'
    ? Object.entries(align).map(([breakpoint, value]) => {
        const prefix = breakpoint === 'sm' ? 'sm:' :
                      breakpoint === 'md' ? 'md:' :
                      breakpoint === 'lg' ? 'lg:' :
                      breakpoint === 'xl' ? 'xl:' :
  ...
  const alignContentClasses = alignContent
    ? (typeof alignContent === 'object'
      ? Object.entries(alignContent).map(([breakpoint, value]) => {
          const prefix = breakpoint === 'sm' ? 'sm:' :
                        breakpoint === 'md' ? 'md:' :
                        breakpoint === 'lg' ? 'lg:' :
                        breakpoint === 'xl' ? 'xl:' :
