...
describe('Flex Accessibility', () => {
  ...
  it('should not have accessibility violations with different directions', async () => {
  ...
  it('should not have accessibility violations with different alignments', async () => {
  ...
  it('should not have accessibility violations with different justifications', async () => {
  ...
  it('should not have accessibility violations with different wraps', async () => {
  ...
  it('should not have accessibility violations with different gaps', async () => {
  ...
  it('should not have accessibility violations with as prop', async () => {
    const { container } = render(
      <Flex as="section">
        <div>Item 1</div>
        <div>Item 2</div>
  ...
  it('should not have accessibility violations with custom styles', async () => {
    const { container } = render(
      <Flex style={{ backgroundColor: 'lightblue', padding: '20px' }}>
        <div>Item 1</div>
        <div>Item 2</div>
        <div>Item 3</div>
      </Flex>
  ...
  it('should not have accessibility violations with nested Flex components', async () => {
    const { container } = render(
      <Flex>
