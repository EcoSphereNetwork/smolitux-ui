  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      <div>
        ...
        <Flex align="stretch" style={{ backgroundColor: '#f3f4f6', padding: '10px', height: '150px' }}>
          <Box>Item 1</Box>
          <Box>Item 2</Box>
          <Box>Item 3</Box>
        </Flex>
      ...
      <div>
        <h3>flex-start</h3>
        <Flex align="flex-start" style={{ backgroundColor: '#f3f4f6', padding: '10px', height: '150px' }}>
          <Box>Item 1</Box>
          <Box>Item 2</Box>
          <Box>Item 3</Box>
        </Flex>
      ...
      <div>
        <h3>flex-end</h3>
        <Flex align="flex-end" style={{ backgroundColor: '#f3f4f6', padding: '10px', height: '150px' }}>
          <Box>Item 1</Box>
          <Box>Item 2</Box>
          <Box>Item 3</Box>
        </Flex>
      ...
      <div>
        <h3>center</h3>
        <Flex align="center" style={{ backgroundColor: '#f3f4f6', padding: '10px', height: '150px' }}>
          <Box>Item 1</Box>
          <Box>Item 2</Box>
          <Box>Item 3</Box>
        </Flex>
      ...
      <div>
        <h3>baseline</h3>
        <Flex align="baseline" style={{ backgroundColor: '#f3f4f6', padding: '10px', height: '150px' }}>
...
export const Wrap: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div>
        <h3>wrap-reverse</h3>
        <Flex wrap="wrap-reverse" style={{ backgroundColor: '#f3f4f6', padding: '10px', width: '300px' }}>
          <Box style={{ width: '120px' }}>Item 1</Box>
          <Box style={{ width: '120px' }}>Item 2</Box>
          <Box style={{ width: '120px' }}>Item 3</Box>
        </Flex>
...
export const Inline: Story = {
  args: {
    inline: true,
    children: [
      <Box key="1" style={{ padding: '10px' }}>Inline</Box>,
      <Box key="2" style={{ padding: '10px' }}>Flex</Box>,
    ],
  },
  decorators: [
    (Story) => (
