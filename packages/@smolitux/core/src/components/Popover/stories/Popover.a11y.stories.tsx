...
const meta: Meta<typeof Popover.A11y> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Eine barrierefreie Version der Popover-Komponente mit verbesserten ARIA-Attributen und Screenreader-Unterstuetzung.',
      },
    },
  },
  argTypes: {
...
export const WithDescription: Story = {
  args: {
    ...
    ariaLabel: 'Informations-Popover',
    description:
      'Diese Beschreibung ist nur für Screenreader sichtbar und bietet zusätzliche Informationen.',
    placement: 'bottom',
    trigger: 'click',
    showArrow: true,
    closeOnEsc: true,
