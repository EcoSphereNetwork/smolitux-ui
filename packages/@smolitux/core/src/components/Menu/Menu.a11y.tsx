// packages/@smolitux/core/src/components/Menu/Menu.a11y.tsx
...
/**
 * Barrierefreie Menu-Komponente für Navigationsmenüs und Dropdown-Menus
 * 
 * @example
 * ```tsx
 ...
 * ```
 */
export const MenuA11y = React.forwardRef<HTMLDivElement, MenuProps>(({
  children,
  variant = 'default',
  direction = 'vertical',
  fullWidth = false,
