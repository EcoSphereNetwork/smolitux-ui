...
describe('TabView Accessibility', () => {
  it('should have no accessibility violations', async () => {
    const { container } = render(<TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" />);
  ...
  it('should handle keyboard navigation correctly', () => {
    render(<TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" />);
  ...
  it('should handle tab activation correctly', () => {
    ...
    render(<TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" onTabChange={handleTabChange} />);
  ...
  it('should handle manual activation correctly', () => {
    ...
    render(
      <TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" onTabChange={handleTabChange} manual />
    );
  ...
  it('should handle vertical orientation correctly', () => {
    render(<TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" vertical />);
  ...
  it('should handle different positions correctly', () => {
    const { rerender } = render(
      <TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" position="top" />
    );

    let tablist = screen.getByRole('tablist');
    expect(tablist).toHaveAttribute('aria-orientation', 'horizontal');

    rerender(<TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" position="left" />);
  ...
  it('should handle error state correctly', () => {
    render(
      <TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" error="Es ist ein Fehler aufgetreten" />
    );
  ...
  it('should handle loading state correctly', () => {
    render(<TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" loading />);
  ...
  it('should handle helper text correctly', () => {
    render(
      <TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" helperText="Wählen Sie einen Tab aus" />
    );
  ...
  it('should handle live region correctly', () => {
    render(<TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" liveRegion />);
  ...
  it('should handle different variants correctly', () => {
    const { rerender } = render(
      <TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" variant="default" />
    );

    let tabs = screen.getAllByRole('tab');
    expect(tabs[0]).toHaveClass('border-b-2');

    rerender(<TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" variant="pills" />);
  ...
  it('should handle different sizes correctly', () => {
    const { rerender } = render(<TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" tabSize="sm" />);

    let tabs = screen.getAllByRole('tab');
    expect(tabs[0]).toHaveClass('text-sm');

    rerender(<TabViewA11y tabs={mockTabs} ariaLabel="Test Tabs" tabSize="lg" />);
