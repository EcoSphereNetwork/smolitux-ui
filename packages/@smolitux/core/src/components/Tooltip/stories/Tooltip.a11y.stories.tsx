...
const meta: Meta<typeof Tooltip.A11y> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Eine barrierefreie Version der Tooltip-Komponente mit verbesserten ARIA-Attributen und Screenreader-Unterstuetzung.'
      }
    }
  },
  argTypes: {
...
export const WithDifferentPositions: Story = {
  render: () => (
    <div className="flex flex-col items-center space-y-8">
      <div>
        <Tooltip.A11y 
          content="Tooltip oben" 
          position="top"
          ariaLabel="Tooltip oben"
        >
          <Button>Oben</Button>
        </Tooltip.A11y>
      </div>
      ...
      <div className="flex space-x-8">
        <Tooltip.A11y 
          content="Tooltip links" 
          position="left"
          ariaLabel="Tooltip links"
        >
          <Button>Links</Button>
        </Tooltip.A11y>
        
        <Tooltip.A11y 
          content="Tooltip rechts" 
          position="right"
          ariaLabel="Tooltip rechts"
        >
      ...
      <div>
        <Tooltip.A11y 
          content="Tooltip unten" 
          position="bottom"
          ariaLabel="Tooltip unten"
        >
          <Button>Unten</Button>
        </Tooltip.A11y>
      </div>
...
export const WithCustomMaxWidth: Story = {
  args: {
    content: 'Dieser Tooltip hat eine benutzerdefinierte maximale Breite von 150px. Der Text wird umgebrochen, wenn er zu lang ist.',
...
export const WithDifferentTriggers: Story = {
  render: () => (
    <div className="space-y-4">
      <div>
        <Tooltip.A11y 
          content="Tooltip für einen Button" 
      ...
      <div>
        <Tooltip.A11y 
          content="Tooltip für einen Link" 
      ...
      <div>
        <Tooltip.A11y 
          content="Tooltip für ein Icon" 
          ariaLabel="Icon-Tooltip"
        >
      ...
      <div>
        <Tooltip.A11y 
          content="Tooltip für ein Bild" 
          ariaLabel="Bild-Tooltip"
        >
          <img 
