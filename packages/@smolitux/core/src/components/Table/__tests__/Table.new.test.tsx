...
describe('Table', () => {
  ...
  it('renders with custom empty state', () => {
    render(
      <Table data={[]} columns={columns} emptyState={<div>Benutzerdefinierte leere Ansicht</div>} />
    );
  ...
  it('handles row click events', () => {
    ...
    render(<Table data={sampleData} columns={columns} onRowClick={handleRowClick} />);
  ...
  it('handles sort events', () => {
    ...
    render(<Table data={sampleData} columns={columns} sortable onSort={handleSort} />);
