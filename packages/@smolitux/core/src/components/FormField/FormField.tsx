...
import { FormField as ValidationFormField, FormFieldProps as ValidationFormFieldProps } from '../../validation/FormField';
    ...
    return (
      <div className={containerClasses} style={style}>
          ...
          >
            ...
            {tooltip && (
              <span className="ml-1 text-gray-400 cursor-help" title={tooltip}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="inline-block w-4 h-4">
        ...
        <div className={labelPlacement !== 'top' ? 'sm:flex-1' : ''}>
          ...
          {(helperText || hasError) && (
            <div className={hasError ? errorTextClasses : helperTextClasses} style={helperTextStyle}>
