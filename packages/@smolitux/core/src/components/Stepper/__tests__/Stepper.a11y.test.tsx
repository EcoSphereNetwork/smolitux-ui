...
describe('Stepper Accessibility', () => {
  it('should have no accessibility violations', async () => {
    const { container } = render(<StepperA11y steps={mockSteps} ariaLabel="Test Stepper" />);
  ...
  it('should handle keyboard navigation correctly', () => {
    render(<StepperA11y steps={mockSteps} ariaLabel="Test Stepper" />);
  ...
  it('should handle vertical orientation correctly', () => {
    render(<StepperA11y steps={mockSteps} ariaLabel="Test Stepper" orientation="vertical" />);
  ...
  it('should handle loading state correctly', () => {
    render(<StepperA11y steps={mockSteps} ariaLabel="Test Stepper" loading />);
  ...
  it('should handle live region correctly', () => {
    render(<StepperA11y steps={mockSteps} ariaLabel="Test Stepper" liveRegion />);
  ...
  it('should handle optional steps correctly', () => {
    render(<StepperA11y steps={mockSteps} ariaLabel="Test Stepper" showOptionalLabel />);
  ...
  it('should handle different variants correctly', () => {
    const { rerender } = render(
      <StepperA11y steps={mockSteps} ariaLabel="Test Stepper" variant="default" />
    );

    let stepper = screen.getByRole('group');
    expect(stepper).toHaveClass('stepper-default');

    rerender(<StepperA11y steps={mockSteps} ariaLabel="Test Stepper" variant="outlined" />);
  ...
  it('should handle different sizes correctly', () => {
    const { rerender } = render(
      <StepperA11y steps={mockSteps} ariaLabel="Test Stepper" size="sm" />
    );

    let stepper = screen.getByRole('group');
    expect(stepper).toHaveClass('stepper-sm');

    rerender(<StepperA11y steps={mockSteps} ariaLabel="Test Stepper" size="lg" />);
  ...
  it('should handle screenreader descriptions correctly', () => {
    ...
    render(<StepperA11y steps={stepsWithScreenReaderDesc} ariaLabel="Test Stepper" />);
