...
const meta: Meta<typeof Breadcrumb> = {
  ...
  argTypes: {
    ...
    maxItems: {
      control: 'number',
      description:
        'Die maximale Anzahl der angezeigten Elemente (mit Ellipsis für überzählige Elemente)',
    },
    responsive: {
      control: 'boolean',
...
export const Default: Story = {
  args: {
    children: [
      ...
      <BreadcrumbItem key="4" isCurrentPage>
        Aktueller Artikel
      </BreadcrumbItem>,
    ],
  },
      ...
      <BreadcrumbItem
        ...
        icon={
          ...
          >
            <path
              fillRule="evenodd"
              d="M4.5 2A2.5 2.5 0 002 4.5v10A2.5 2.5 0 004.5 17h10a2.5 2.5 0 002.5-2.5v-10A2.5 2.5 0 0014.5 2h-10zm1 1.5a1 1 0 00-1 1V15a1 1 0 001 1h8a1 1 0 001-1V4.5a1 1 0 00-1-1h-8z"
              clipRule="evenodd"
            />
          </svg>
        }
...
export const WithMaxItems: Story = {
  args: {
    ...
    children: [
      ...
      <BreadcrumbItem key="5" href="#">
        Elektronik
      </BreadcrumbItem>,
      <BreadcrumbItem key="6" isCurrentPage>
        Smartphones
      </BreadcrumbItem>,
    ],
  },
...
export const Responsive: Story = {
  args: {
    ...
    children: [
      ...
      <BreadcrumbItem key="5" isCurrentPage>
        Aktueller Artikel mit einem sehr langen Namen
      </BreadcrumbItem>,
    ],
  },
};
...
export const WithCustomStyling: Story = {
  render: () => (
    <Breadcrumb className="p-3 bg-blue-50 dark:bg-blue-900 rounded-lg" separator="/">
      <BreadcrumbItem
        href="#"
      ...
      <BreadcrumbItem isCurrentPage className="font-bold text-blue-800 dark:text-blue-100">
        Artikel
      </BreadcrumbItem>
    </Breadcrumb>
  ),
