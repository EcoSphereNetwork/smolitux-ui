...
describe('Alert Accessibility', () => {
  it('should not have accessibility violations in basic state', async () => {
    const { violations } = await a11y.testA11y(<Alert type="info" message="Test message" />);
  ...
  it('should have correct ARIA attributes with title', () => {
    render(
      <Alert type="warning" title="Warning Title" message="Warning message" id="test-alert" />
    );
  ...
  it('should support keyboard interaction for closing', () => {
    ...
    render(<Alert type="success" message="Success message" closable onClose={onClose} />);
  ...
  it('should be focusable when autoFocus is true', () => {
    render(<Alert type="info" message="Info message" autoFocus />);
