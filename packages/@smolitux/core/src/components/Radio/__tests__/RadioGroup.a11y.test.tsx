...
describe('RadioGroup Accessibility', () => {
  it('should have no accessibility violations', async () => {
    const { container } = render(
      <RadioGroupA11y name="test" label="Wählen Sie eine Option" ariaLabel="Optionsauswahl">
  ...
  it('should handle busy state correctly', () => {
    render(
      <RadioGroupA11y name="test" label="Wählen Sie eine Option" busy ariaLabel="Optionsauswahl">
        <RadioA11y value="option1" label="Option 1" />
        <RadioA11y value="option2" label="Option 2" />
      </RadioGroupA11y>
    );
