...
describe('Slider', () => {
  ...
  test('renders with custom size', () => {
    ...
    expect(screen.getAllByRole('slider')[0].parentElement?.querySelector('div')).toHaveClass(
      'h-1.5'
    );
  ...
  test('renders with different color schemes', () => {
    ...
    expect(screen.getAllByRole('slider')[0].parentElement?.querySelector('div > div')).toHaveClass(
      'bg-secondary-600'
    );
  ...
  test('handles change events for range slider', () => {
    ...
    render(
      <Slider isRange value={20} value2={80} onChange={handleChange1} onChange2={handleChange2} />
    );
  ...
  test('renders with custom value format', () => {
    render(<Slider showValue value={50} valueFormat={(value) => `${value}%`} />);
  ...
  test('applies custom className correctly', () => {
    ...
    expect(screen.getAllByRole('slider')[0].parentElement?.parentElement).toHaveClass(
      'custom-class'
    );
  });
