...
describe('Slider Accessibility', () => {
  ...
  it('should handle helper text correctly', () => {
    ...
    const helperText = screen.getByText('Ziehen Sie den Schieberegler, um die Lautstärke einzustellen');
  ...
  it('should handle live region correctly', () => {
    ...
    const liveRegion = screen.getByRole('slider').parentElement?.querySelector('[aria-live="assertive"]');
