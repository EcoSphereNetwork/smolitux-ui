...
describe('FlexA11y', () => {
  ...
  it('renders with correct ARIA attributes', () => {
    render(
      <FlexA11y role="navigation" ariaLabel="Main Navigation" data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA expanded state', () => {
    render(
      <FlexA11y ariaExpanded={true} data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA live region', () => {
    render(
      <FlexA11y ariaLive="polite" ariaAtomic={true} data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct tabIndex', () => {
    render(
      <FlexA11y tabIndex={0} data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA current state', () => {
    render(
      <FlexA11y ariaCurrent="page" data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA level', () => {
    render(
      <FlexA11y ariaLevel={2} data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA position in set', () => {
    render(
      <FlexA11y ariaSetsize={5} ariaPosinset={2} data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA role description', () => {
    render(
      <FlexA11y ariaRoledescription="slide" data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA key shortcuts', () => {
    render(
      <FlexA11y ariaKeyshortcuts="Control+S" data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA owns', () => {
    render(
      <FlexA11y ariaOwns="element-id" data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA controls', () => {
    render(
      <FlexA11y ariaControls="element-id" data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA describedby', () => {
    render(
      <FlexA11y ariaDescribedby="description-id" data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA labelledby', () => {
    render(
      <FlexA11y ariaLabelledby="label-id" data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA hidden', () => {
    render(
      <FlexA11y ariaHidden={true} data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA haspopup', () => {
    render(
      <FlexA11y ariaHaspopup={true} data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA busy', () => {
    render(
      <FlexA11y ariaBusy={true} data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
  ...
  it('renders with correct ARIA relevant', () => {
    render(
      <FlexA11y ariaRelevant="additions text" data-testid="flex-container">
        <div>Flex content</div>
      </FlexA11y>
    );
