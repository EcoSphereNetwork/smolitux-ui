...
export { default as Grid, type GridProps, type GridItemProps } from './components/Grid/Grid';
...
export { default as DashboardLayout, type DashboardLayoutProps } from './components/DashboardLayout/DashboardLayout';
