  ...
  const renderTrendChart = () => {
    ...
    return (
      <div
        ...
        aria-label={
          isChart
            ? `Stimmungstrend mit ${trend.length} Datenpunkten. Minimaler Wert: ${minValue.toFixed(2)}, Durchschnittlicher Wert: ${avgValue.toFixed(2)}, Maximaler Wert: ${maxValue.toFixed(2)}`
            : undefined
        }
      >
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-8">
              ...
              <div className="md:w-1/3">
                <div
                  ...
                  aria-label={
                    isMeter
                      ? `Gesamtstimmung: ${getSentimentText(calculatedOverallSentiment)}`
                      : undefined
                  }
                  ...
                  aria-valuetext={
                    isMeter ? `${(calculatedOverallSentiment * 100).toFixed(0)}%` : undefined
                  }
                >
                  <h4
                      ...
                      {topics.map((topic, index) => (
                        <li
                          ...
                          className={`p-2 rounded-md ${
                            hoveredTopic === topic.name ? 'bg-gray-100 dark:bg-gray-600' : ''
                          }`}
