...
describe('ContentModerator', () => {
  ...
  it('calls onApprove when approve button is clicked', async () => {
    ...
    render(<ContentModerator onModerate={mockModerateImplementation} onApprove={mockOnApprove} />);
  ...
  it('calls onReject when reject button is clicked', async () => {
    ...
    render(<ContentModerator onModerate={mockModerateImplementation} onReject={mockOnReject} />);
  ...
  it('calls onFlagContent when flag button is clicked', async () => {
    ...
    render(
      <ContentModerator onModerate={mockModerateImplementation} onFlagContent={mockOnFlagContent} />
    );
    ...
    expect(mockOnFlagContent).toHaveBeenCalledWith(
