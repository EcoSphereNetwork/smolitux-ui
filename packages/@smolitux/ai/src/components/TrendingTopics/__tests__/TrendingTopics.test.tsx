...
describe('TrendingTopics', () => {
  ...
  it('calls onTopicClick when a topic is clicked', () => {
    render(<TrendingTopics topicsData={mockTopicsData} onTopicClick={mockOnTopicClick} />);
  ...
  it('calls onTimeframeChange when timeframe is changed', () => {
    render(
      <TrendingTopics topicsData={mockTopicsData} onTimeframeChange={mockOnTimeframeChange} />
    );
  ...
  it('calls onRefresh when refresh button is clicked', () => {
    render(<TrendingTopics topicsData={mockTopicsData} onRefresh={mockOnRefresh} />);
  ...
  it('calls onExport when export button is clicked', () => {
    render(<TrendingTopics topicsData={mockTopicsData} onExport={mockOnExport} />);
