...
describe('EngagementScore', () => {
  ...
  it('calls onPeriodChange when period is changed', () => {
    render(
      <EngagementScore engagementData={mockEngagementData} onPeriodChange={mockOnPeriodChange} />
    );
  ...
  it('calls onRefresh when refresh button is clicked', () => {
    render(<EngagementScore engagementData={mockEngagementData} onRefresh={mockOnRefresh} />);
  ...
  it('calls onExport when export button is clicked', () => {
    render(<EngagementScore engagementData={mockEngagementData} onExport={mockOnExport} />);
