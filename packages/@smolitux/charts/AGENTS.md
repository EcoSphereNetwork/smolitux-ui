# Smolitux UI - charts Package

This document provides package-specific guidance for AI agents working with the `@smolitux/charts` package in the Smolitux UI component library.

## 📋 Package Overview

The `@smolitux/charts` package provides charts components for the Smolitux UI component library. These components are used to structure and organize the UI.

## 🧩 Component Categories

The charts package includes the following component categories:
...
For each component in the charts package, follow this workflow:
...
bash scripts/workflows/analyze-repo.sh --package charts --component $COMPONENT
```

### 2. Completion Phase
```bash
# Complete component
bash scripts/workflows/complete-components.sh --package charts --component $COMPONENT
```

### 3. Validation Phase
```bash
# Validate component
bash scripts/workflows/validate-quality.sh --package charts --component $COMPONENT
```
...
All charts components must meet the following requirements:
...
- [charts Package Guidelines](../../docs/wiki/codex/package-specific/charts.md)
