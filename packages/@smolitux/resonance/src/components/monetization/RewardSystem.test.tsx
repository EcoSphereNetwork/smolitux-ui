...
describe('RewardSystem', () => {
  ...
  it('renders correctly with default props', () => {
    render(
      <RewardSystem rewards={mockRewards} user={mockUser} />
    );
  ...
  it('renders with custom className', () => {
    render(
      <RewardSystem rewards={mockRewards} user={mockUser} className="custom-rewards" data-testid="reward-system" />
    );
  ...
  it('renders with custom style', () => {
    render(
      <RewardSystem rewards={mockRewards} user={mockUser} style={{ backgroundColor: 'lightblue' }} data-testid="reward-system" />
    );
  ...
  it('renders with different layout styles', () => {
    const { rerender } = render(
      <RewardSystem rewards={mockRewards} user={mockUser} layout="grid" data-testid="reward-system" />
    );
    ...
    rerender(
      <RewardSystem rewards={mockRewards} user={mockUser} layout="list" data-testid="reward-system" />
    );
  ...
  it('renders with progress indicators', () => {
    render(
      <RewardSystem rewards={mockRewards} user={mockUser} showProgress data-testid="reward-system" />
    );
  ...
  it('renders with reward details when expanded', () => {
    render(
      <RewardSystem rewards={mockRewards} user={mockUser} expandable />
    );
