...
describe('VotingSystem', () => {
  ...
  it('renders correctly with default props', () => {
    render(<VotingSystem proposal={mockProposal} />);
  ...
  it('displays vote counts correctly', () => {
    render(<VotingSystem proposal={mockProposal} showResults />);
  ...
  it('calls onVote when an option is selected', () => {
    ...
    render(<VotingSystem proposal={mockProposal} onVote={handleVote} />);
  ...
  it('disables voting when proposal is closed', () => {
    ...
    const handleVote = jest.fn();
    render(<VotingSystem proposal={closedProposal} onVote={handleVote} />);
  ...
  it('disables voting when user has already voted', () => {
    const handleVote = jest.fn();
    render(<VotingSystem proposal={mockProposal} onVote={handleVote} userVote="Yes" />);
  ...
  it('renders with weighted voting when enabled', () => {
    render(<VotingSystem proposal={mockProposal} weightedVoting data-testid="voting-system" />);
