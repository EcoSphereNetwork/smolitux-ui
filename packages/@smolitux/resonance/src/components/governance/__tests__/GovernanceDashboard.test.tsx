...
describe('GovernanceDashboard', () => {
  const mockProposals = [
    {
      ...
      description:
        'Proposal to implement a token burning mechanism to reduce supply and increase value.',
      status: 'active',
    ...
    },
    {
      ...
      description:
        'Proposal to add 5 new community moderators to help manage the growing community.',
      status: 'pending',
  ...
  it('renders correctly with proposals and stats', () => {
    render(<GovernanceDashboard proposals={mockProposals} stats={mockStats} />);
  ...
  it('calls onRefresh when refresh button is clicked', () => {
    render(
      <GovernanceDashboard proposals={mockProposals} stats={mockStats} onRefresh={mockOnRefresh} />
    );
