...
describe('ProfileWallet', () => {
  const mockWallet = {
    ...
    currency: 'SMX',
    transactions: [
      { id: 'tx1', type: 'receive', amount: '500', from: '0xabcdef', to: '0x1234', timestamp: '2025-03-15T10:30:00Z', status: 'completed' },
      { id: 'tx2', type: 'send', amount: '200', from: '0x1234', to: '0xabcdef', timestamp: '2025-03-14T14:20:00Z', status: 'completed' },
      { id: 'tx3', type: 'stake', amount: '300', from: '0x1234', timestamp: '2025-03-13T09:15:00Z', status: 'completed' }
    ],
    rewards: [
  ...
  it('renders correctly with default props', () => {
    render(
      <ProfileWallet wallet={mockWallet} />
    );
  ...
  it('displays reward history', () => {
    render(
      <ProfileWallet wallet={mockWallet} showRewards />
    );
  ...
  it('calls onSend when send button is clicked', () => {
    ...
    render(
      <ProfileWallet wallet={mockWallet} onSend={handleSend} />
    );
  ...
  it('calls onReceive when receive button is clicked', () => {
    ...
    render(
      <ProfileWallet wallet={mockWallet} onReceive={handleReceive} />
    );
  ...
  it('calls onStake when stake button is clicked', () => {
    ...
    render(
      <ProfileWallet wallet={mockWallet} onStake={handleStake} />
    );
  ...
  it('renders with custom style', () => {
    render(
      <ProfileWallet wallet={mockWallet} style={{ backgroundColor: 'lightblue' }} data-testid="profile-wallet" />
    );
  ...
  it('renders QR code when showQR is true', () => {
    render(
      <ProfileWallet wallet={mockWallet} showQR />
    );
